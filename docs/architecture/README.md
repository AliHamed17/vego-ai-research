...
2. **\ramework-diagram.md\** — H-layer framework view (July 2026 supervisor redirect)
3. **\valuation-diagram.md\** — parked evaluation track (separate by directive)
4. **\workspace-diagram.md\** — visual workspace layout
5. **\progress-update-diagram.md\** — how progress tracking works
6. **\esearch-lifecycle.md\** — end-to-end research flow
7. **\eproducibility-contract.md\** — what we commit to for reproducibility
