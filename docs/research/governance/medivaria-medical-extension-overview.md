...
| --- | --- | --- | --- |
| MV-01 | A four-agent VEGO-AI pipeline was "submitted to ACM/IEEE MODELS 2026" | **Verified after call, with a correction (2026-08-11)** — the paper exists and is *published*, not merely submitted: DOI `10.1145/3822455.3830312`, MODELS '26, Málaga. Authors are Reinhartz-Berger, Bragilovski, and Sturm; Ali is not an author. See the [foundation paper record](./vego-ai-foundation-paper-record.md) | — closed |
| MV-02 | Empirical TRL-3 baseline: Language Advisor F-scores 0.75–1.0; Domain Advisor guideline alignment 0.70–0.88; compliance scoring 0.80–0.96 "against expert review"; all identified variability patterns validated correct by domain experts | **Verified after call, with one correction and a completeness caveat (2026-08-11).** The three numeric ranges are *exactly* accurate against the paper's Tables 2 and 3 and its Phase B results. The fourth clause is **overstated**: the paper validates the 8 *substantial* patterns of 26, and the judges were *the authors*, not independent domain experts. The one-pager also omits the weaker findings reported alongside — uncovered-audit scores of 0.55–0.88 and a weak grader correlation (ρ = 0.22). Full detail in the [foundation paper record](./vego-ai-foundation-paper-record.md) | — closed, with the corrected wording to be used in any reuse |
...
**Resolved 2026-08-11 — MV-02 is now verified against its source.** The paper was supplied and read; see the [foundation paper record](./vego-ai-foundation-paper-record.md) for the full check. Three of the four claims are exactly accurate; the fourth ("all identified variability patterns validated correct by domain experts") overstates both scope and independence and must be restated as "the eight patterns classified as substantial variability were judged correct by the paper's authors" wherever it is reused.

**The distinction that still holds:** these figures are **not** the same artifact as EXP-005 (`reports/generated/exp005-gate.json`, still 0 of 24 supplied labels, no accuracy claim authorized). They evaluate the *published foundation framework* on software/modeling data. EXP-005 evaluates *this doctorate's own* human-judgment-reuse layer. Citing the paper's numbers says nothing about the doctoral contribution's performance, and the two must never be presented as one evidence base.
