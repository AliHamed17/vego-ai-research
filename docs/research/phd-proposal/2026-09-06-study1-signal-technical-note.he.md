...
ההתרעה היא מועמד בלבד. עבור אותות ה-Q&A אין חיבור אוטומטי לתור או תיקון; זהו reporting label בלבד. קיים ב-code תור נפרד עבור Agent 4, אך הוא אינו מוזן אוטומטית מ-Detector-v1.
