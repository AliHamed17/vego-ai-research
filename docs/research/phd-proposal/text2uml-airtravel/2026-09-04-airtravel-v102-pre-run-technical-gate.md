...
|---|---|
| A. Current `main` SHA | `caabced2d16625c2eb2a98ae408bcbb496382857` (pushed to `origin/main`). |
...
| R. CI | Latest pushed run `33879752244` (head `caabced…`): Python 3.10/3.11/3.12/3.13 **SUCCESS**; Source/security/documents **FAIL** at stale `docs/research/hardening/release-manifest-v3.json`; merge-gate **FAIL**. CI is not green. |
