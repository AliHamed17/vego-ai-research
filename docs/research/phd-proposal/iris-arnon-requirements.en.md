# Iris & Arnon Requirements — Consolidated (English)

Every requirement, directive, and action item Prof. Iris Reinhartz-Berger and Prof. Arnon Sturm
have given across the three recorded supervisor calls to date (2026-07-29, 2026-08-05,
2026-08-12), pulled into one list. Source of truth stays with the three full records — this is a
consolidated summary for quick reference, not a replacement:
...
All three calls exist only as machine (ASR) transcripts with no verified speaker diarization.
Every requirement here is a reviewed paraphrase of that machine transcript, not a verbatim
quotation, and none of it is a supervisor-confirmed final decision until Ali checks it against
his own memory of the call. Do not present anything below as "Iris said, verbatim" or as formally
approved.

Status key: Open = not yet done. Done = completed as stated. Ongoing = a standing constraint,
not a one-time task. Info = supervisor-side context, not an action for Ali.

---

1. From the 2026-07-29 call (R-01 to R-19)
...
2. From the 2026-08-05 call — directives (E1 to E15)
...
3. From the 2026-08-12 call — directives

| # | Requirement | Status |
| --- | --- | --- |
| 1 | Move the literature-review chapter and the methodology chapter from "thinking about it" to active writing. | Later resequenced same call, see item 10 |
| 2 | The literature review must justify the gap, and the gap must live in the problem world, not describe the solution. | Ongoing guidance |
| 3 | Focus the review on literature bearing on the actual RQs; separate out enabling-technology references (e.g. neural-net infrastructure) — those are citations, not literature-review content. | Ongoing guidance |
| 4 | Center of gravity for the literature: human involvement in the context of agentic AI, not tied to one specific domain. A separate subsection can cover the SE/medical scenario framing. | Ongoing guidance |
...
| 13 | Student and university work cannot go through ordinary hosted LLMs, the same privacy constraint as the medical setting (info only). | Info, affects tooling choice |

3a. From the 2026-08-12 call — actions
...
- E8: "human" vs. "expert" judgment across the question set.
- The Plan A/Plan B boundary wording and the evidence-boundary wording: never formally signed off, only used informally.
- Owner assignment for medical-feasibility verification and for the official university candidacy-process inquiry.
- A08-01: the exact final RQ/SQ wording from the 08-05 live-edit session; no saved copy of that chat has been located.

5. Unchanged evidence gates, true across all three calls

| Gate | Value |
| --- | --- |
| EXP-005 generalization-safe expert labels | 0 of 24 |
| Medical entry gates, G1 to G6 | 0 of 6 |
| Literature searches QL-01 to QL-05 | Not executed |
