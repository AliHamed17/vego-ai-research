...
Generated from repository memory on 2026-08-19 02:12 +03:00.
...
| EXP-035 | Fault injection and authority safety | Offline evidence | Architecture safety | `experiments/EXP-035-fault-injection-authority-safety/`, `scripts/run_bigui_architecture_experiments.py` | Accepted deterministic negative-fixture manifests and safety matrix | The finite fault catalog passed baseline preservation, zero unsafe memory writes, zero correction applications, and correct park/escalate behavior. |
