...
Generated: 2026-09-06 03:32 +03:00.
...
| Field | Value |
| --- | --- |
| Branch | study2/vego-ai-on-off-preparation |
| Upstream | origin/study2/vego-ai-on-off-preparation |
| HEAD | f3b4c22 |
...
| Source | Rollup |
| --- | --- |
| docs/dashboards/kpi-register.md | Green 11, Yellow 13, Red 2, Blocked 5 |
| docs/agent-memory/progress.md active work | Blocked 1, Open 12, In progress 3, Done 17, Other 4 |
...
| KPI green rate | 11 of 31 green | [#######-------------] 35% |
| Active work closed | 22 of 51 done | [#########-----------] 43% |
| Executive snapshot green | 6 of 23 green | [#####---------------] 26% |
...
| KPIs green | 11 of 31 | [#######-------------] 35% |
| Active work done | 22 of 51 | [#########-----------] 43% |
| Executive dashboard green | 6 of 23 | [#####---------------] 26% |
| Review verdict | not generated | Next action: Run .\scripts\run-project-review.ps1 -UpdateReviewState. |
| Git workspace | study2/vego-ai-on-off-preparation @ f3b4c22 | 11 pending status rows |
