...
Generated: 2026-09-08 07:35 +03:00.
...
| Field | Value |
| --- | --- |
| Branch | study2/on-off-readiness-correction |
| Upstream | origin/study1/closure-and-study2-prep |
| HEAD | a863a45 |
...
| July 29 call extraction and assurance | Structure green / human gates blocked | S-0001â€“S-1195 preliminary CSV/JSON and review workbook; 910 machine-linked rows, 285 human-review placeholders; separate Reviewer A/B and third-person merge interface; IRIS-EXP-01â€“10 validator. | Complete both 1,195-segment reviews plus one full-media record per reviewer and adjudicate every disagreement; readiness/closure remain non-zero meanwhile. |
...
| Active work closed | 24 of 53 done | [#########-----------] 45% |
...
| Git workspace | study2/on-off-readiness-correction @ a863a45 | 8 pending status rows |
...
| EXP-013â€“018 conformance fixtures (2026-07-10) | Six CLIs pass; 24 focused tests; offline validator 19/19 PASS | Ignored `reports/generated/exp013/` through `exp018/` | Fixture-level contract, determinism, workload, authority, provenance, and proposal-safety evidence. No empirical-performance or runtime-authorization claim. |
...
- No performance or improvement claim is permitted for Study 1: no independent quality measure exists. For any other programme area, such a claim additionally requires an experiment record and a publishability decision â€” the linkage is a necessary condition, never a sufficient one.
