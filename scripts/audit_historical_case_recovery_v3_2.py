...
def write_outputs(result: dict[str, Any], output_root: Path) -> None:
    ...
    safe_keys = ("audit_version", "audit_base_sha", "evidence_parent_sha", "backup_sha256", "archive_entry_count", "normalized_model_count", "file_level_match", "duplicate_id_excess", "airtravel_manifest_verification", "airtravel_source_verification", "airtravel_source_runtime_mapping", "airtravel_runtime_pack_verification", "airtravel_fake_preflight", "airtravel_materialization", "gate_tracks", "call_bound", "api_cost", "protected_authorization", "instrumentation", "paid_run_authorization", "provider_calls", "experiment_calls", "detector_v1_runs")
